...
[System.Serializable]
public class boxTableROW2 : MonoBehaviour
{
   ...
   public void CreateBox(string jsonD)
    {
        ...
        PlayerInfo1[] PInfo = JsonHelper1.getJsonArray<PlayerInfo1>(jsonD);
...
{
    public static T[] getJsonArray<T>(string json1)
    {
        string newJson1 = "{ \"array\": " + json1 + "}";
        Wrapper1<T> wrapper = JsonUtility.FromJson<Wrapper1<T>>(newJson1);
